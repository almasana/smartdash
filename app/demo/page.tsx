...
export default async function DemoPage() {
  ...
  const clientes = (clientesRaw || [])
    ...
    .map((c) => ({
      ...c,
      href: `/demo/casos/${c.id}` // Ajustado para ir a la ruta de casos específica
    }));
  ...
  return (
    <div className="min-h-screen bg-[#FDFDFF]">
      ...
      <div id="clientes-section" className="px-8 py-12 max-w-7xl mx-auto scroll-mt-20">
        <h1 className="text-3xl font-black text-slate-900 mb-4 tracking-tight">
          Panel de Clientes
        </h1>

        <p className="text-sm sm:text-base text-slate-600 mb-8 leading-relaxed max-w-3xl">
          Seleccioná un cliente para descubrir los escenarios de riesgo que enfrenta, y cómo <span className="font-semibold text-orange-600">SmartDash</span> detecta, comunica y te ayudará a prevenir problemas antes de que ocurran.
        </p>
